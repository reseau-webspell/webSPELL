...
class SplashtoonAPI {
    constructor(module) {
        ...
        this._url = 'https://splashtoon.fr/feed/';
    ...
    timer() {
        setInterval(() => {
            this.bot.Logger.verbose('RSS FEED - API requesting Splashtoon.');
            this.run();
        }, 600000);
    }
    ...
    async getGuilds() {
        ...
        this.lastArticle = rssSchema.SplashtoonLast;
        this.guilds = rssSchema.SplashtoonWH; // cache webhooks
        return rssSchema.SplashtoonWH;
    }
     ...
     * @returns {Promise<Object|null>} Old Guild Obj or null
     * @memberof SplashtoonAPI
     */
    async removeGuildObj(gID) {
